...
public class myAsyncTask extends AsyncTask<Void,Void,Integer> {
    ...
    public interface AsyncResponse {
        void processFinish(List<DetailsData> output);
    ...
    public myAsyncTask (Context context,AsyncResponse delegate, int type){
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        progressDialog=new ProgressDialog((DataAnalysisActivity)contextRef.get());
